 ...
 *
 */
namespace FBJKFacebook\GraphNodes;

use FBJKFacebook\FacebookResponse;
...
class GraphNodeFactory
{
     ...
     */
    const BASE_GRAPH_NODE_CLASS = '\FBJKFacebook\GraphNodes\GraphNode';

    /**
     * @const string The base graph edge class.
     */
    const BASE_GRAPH_EDGE_CLASS = '\FBJKFacebook\GraphNodes\GraphEdge';

    /**
     * @const string The graph object prefix.
     */
    const BASE_GRAPH_OBJECT_PREFIX = '\FBJKFacebook\GraphNodes\\';
